...
const STORE = {
  cats: [
    ...
    {
      imageURL:
        'https://images.immediate.co.uk/volatile/sites/4/2018/08/iStock_000044061370_Medium-fa5f8aa.jpg',
      imageDescription:
    ...
    {
      imageURL:
        'https://www.cathaven.com.au/assets/cats/_resampled/croppedimage685450-4058680314268048674532858160440997726126080o.jpg',
      imageDescription:
    ...
    },
    {
      ...
      imageDescription: 'Domestic Short Hair with green eyes.',
      name: 'Crunch',
      sex: 'Male',
      age: 8,
      breed: 'DSH',
  ...
  dogs: [
    ...
    {
      imageURL:
        'https://img.freepik.com/free-photo/husky-breed-dog-with-tongue-out_1187-1500.jpg?size=338&ext=jpg',
    ...
    {
      imageURL:
        'https://www.dogster.com/wp-content/uploads/2017/10/Havenese-1.jpg',
